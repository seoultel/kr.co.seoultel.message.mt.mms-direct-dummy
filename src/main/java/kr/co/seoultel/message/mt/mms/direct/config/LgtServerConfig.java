...
public class LgtServerConfig {
    ...
    @Bean
    public QueueStorage<LgtDeliveryReportReqMessage> reportQueueStorage(@Value("${direct.storage.report.file-path}") String filePath) throws IOException {
        QueueStorage<LgtDeliveryReportReqMessage> queueStorage = new QueueStorage<LgtDeliveryReportReqMessage>(filePath);
        Type type = new TypeToken<Collection<LgtDeliveryReportReqMessage>>(){}.getType();
