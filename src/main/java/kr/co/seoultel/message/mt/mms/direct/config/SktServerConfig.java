...
public class SktServerConfig {
    ...
    @Bean
    public QueueStorage<SktDeliveryReportReqMessage> reportQueueStorage(@Value("${direct.storage.report.file-path}") String filePath) throws IOException {
        QueueStorage<SktDeliveryReportReqMessage> queueStorage = new QueueStorage<SktDeliveryReportReqMessage>(filePath);
        Type type = new TypeToken<Collection<SktDeliveryReportReqMessage>>(){}.getType();
