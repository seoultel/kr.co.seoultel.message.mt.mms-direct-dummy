...
//@Slf4j
//@Component
//public class SvrReportProcessor extends kr.co.seoultel.mms.server.core.modules.SvrReportProcessor<SoapMessage> {
//    private final Set<MessageHistory> messageHistories;
//    protected SvrReportProcessor(DefaultServer server, ConcurrentLinkedQueue<SmtntDeliveryAckMessage> reportQueue, Set<MessageHistory> messageHistories) {
